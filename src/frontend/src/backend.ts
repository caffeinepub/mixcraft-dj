...
export class Backend implements backendInterface {
    ...
    async getSession(): Promise<DeckState> {
    ...
    async removeSession(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeSession();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveSession(arg0: DeckState): Promise<void> {
        if (this.processError) {
            try {
    ...
    async saveApiKey(key: string): Promise<void> {
        if (this.processError) {
            try {
                return await this.actor.saveApiKey(key);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async removeApiKey(): Promise<void> {
        if (this.processError) {
            try {
                return await this.actor.removeApiKey();
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
